...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin'], function () {
    ...
    // popups
    Route::get('popups', 'Popups@index')->name('popups');
    Route::get('popups/crear', 'Popups@crear')->name('crear_popup');
    Route::get('popups/{popup}/editar', 'Popups@editar')->name('editar_popup');
    Route::post('popups/guardar/{popup?}', 'Popups@guardar')->name('guardar_popup');
    Route::get('popups/{popup}/eliminar', 'Popups@eliminar')->name('eliminar_popup');
    Route::get('popups/{popup}/eliminar-archivo/{campo}', 'Popups@eliminarArchivo')->name('eliminar_archivo_popup');
    Route::get('popups/{popup}/visibilidad', 'Popups@visibilidad')->name('visibilidad_popup');
});
