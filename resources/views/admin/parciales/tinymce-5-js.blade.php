...
<script src="https://cdn.tiny.cloud/1/eux1k75leha8st9svk0eyo2phwudbxabxc58vlq4gozrskb4/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
	...
	tinymce.init({
      ...
      images_upload_handler: function (blobInfo, success, failure) {
          ...
          axios.post('{{ route("subir-tiny") }}', data)
              ...
              .catch(function (err) {
                  failure('Ocurrió un error al subir la imagen, revisar que el formato sea válido y que no pese demasiado.');
              });
      }
