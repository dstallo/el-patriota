                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{{ route('AdministradoresEditar', ['administrador' => Auth::user()]) }}" class="btn btn-default btn-flat">Editar cuenta</a>
                                    </div>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu nav" data-widget="tree">
                    ...
                    <li><a href="{{ url('admin/regiones') }}"><i class="fa fa-fw fa-sitemap"></i><span>Regiones</span></a></li>
                    ...
                    <li><a href="{{ url('admin/newsletter/inscriptos') }}"><i class="fa fa-envelope"></i> Newsletter</a></li>
                </ul>
                <!-- /.sidebar-menu -->
            </section>
            <!-- /.sidebar -->
